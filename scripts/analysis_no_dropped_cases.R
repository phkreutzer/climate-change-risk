...
stargazer(risk_means_out,
          label = "tab:no_dropped_casesrisk_means_comparison",
          summary = FALSE,
          rownames = FALSE,
          header = FALSE,
          out = './tables/no-dropped-cases-group_means_risk.tex')
...
stargazer(aovs_risk_out, 
          title = "ANOVA of Total Perceived Risk by Treatment Condition; No Dropped Cases",
          label = "tab:no_dropped_casestotal_risk_anova_treatment",
          object.names = TRUE,
          rownames = FALSE,
          notes = "Unequal group sizes adjusted using type 2 correction.",
          header = FALSE,
          summary = FALSE,
          out = "./tables/no-dropped-cases-anova-risk-type-II.tex")
...
rhs <- "~ factor(treatment_doom)*factor(treatment_inevitable) + ocsi_score + as.double(education) + as.double(income) + gender + age"
...
stargazer(risk_perception_models,
          title = "Analysis of Risk Perception Factors; No Dropped Cases",
          label = "tab:no_dropped_casesrisk_perception_ols",
          ...
          out = './tables/no-dropped-cases-risk-perceptions-ols.tex')
...
stargazer(lottery_donation_means,
          label="tab:no_dropped_caseslottery_means_comparison",
          summary=FALSE,
          header=FALSE,
          out = './tables/no-dropped-cases-group_means_lottery.tex')
...
stargazer(aovs_lottery_out, 
          title = "ANOVA of Donation Decision by Treatment Condition; No Dropped Cases",
          label = "tab:no_dropped_caseslottery_donation_anova_treatment",
          notes = "Unequal group sizes adjusted using type 2 correction.",
          object.names = TRUE,
          rownames = FALSE,
          header = FALSE,
          summary = FALSE,
          out='./tables/no-dropped-cases-lottery-donation-anova-type-II.tex')


# OLS Analysis

model_lottery_risk_total <- 'lottery_donation ~ risk_total + 
                                     trust + ocsi_score + as.double(education) + 
...
stargazer(lottery_out,
          title = "Analysis of Donation Decision; No Dropped Cases",
          label = "tab:no_dropped_caseslottery_donation_ols",
          ...
          omit.stat = "ser",
          out.header = FALSE,
          out = './tables/no-dropped-cases-lottery-donation-ols.tex')
